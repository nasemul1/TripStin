...
const ProfileInfo = () => {
  ...
  return (
    <div className='mx-auto mt-28 mb-8 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] font-poppins text-slate-800'>
      { message ? <div className='flex flex-col items-center justify-center h-[540px]'>
          <p className='text-center text-2xl text-slate-800 font-semibold'>{message}</p>
          <p className='mt-2 md:mt-4 text-gray-600 text-center w-3/4'>We are glad, that you're with us ? We've sent you a verification link to the email address</p>
        </div>
        :
