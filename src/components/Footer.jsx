...
const Footer = () => {
  return (
    <footer className="mt-4 w-full text-gray-700 bg-slate-900 body-font">
        <div className="container flex flex-col flex-wrap gap-y-8 px-5 py-24 mx-auto md:items-center xl:items-start md:flex-row md:flex-no-wrap">
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                ...
                <p className="mt-2 text-sm text-gray-400">Exploring made easy</p>
                <div className="mt-4">
            ...
            <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center lg:pl-20 md:mt-0 md:text-left">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    <h2 className="mb-3 text-sm font-medium tracking-widest text-gray-200 uppercase title-font">Platform
                    </h2>
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
        ...
        <div className="bg-slate-950">
            <div className="container px-5 py-4 mx-auto">
                <p className="text-sm text-gray-400 capitalize xl:text-center">© 2024 All rights reserved </p>
            </div>
        </div>
    </footer>
  )
