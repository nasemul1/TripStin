        ...
        <div className='mt-10 w-full flex flex-col items-center'>
            ...
            <div className='w-full flex justify-center gap-x-6'>
                ...
                <Link to='/travel_blog/2' className="p-2 flex flex-col items-center group">
                    <div className='w-[340px] h-[180px] overflow-hidden rounded-md'>
                        <img src={tanguar} alt="" className='w-[340px] object-cover transition-transform duration-500 ease-in-out group-hover:scale-125'/>
                    </div>
                    <h3 className='mt-2 w-[340px] text-lg group-hover:text-red-500 text-center font-semibold'>7 Tips for visiting Tanguar Haor</h3>
                </Link>
                <Link to='/travel_blog/3' className="p-2 flex flex-col items-center group">
                    <div className='w-[340px] h-[180px] overflow-hidden rounded-md'>
                        <img src={kuakata} alt="" className='w-[340px] object-cover transition-transform duration-500 ease-in-out group-hover:scale-125'/>
                    </div>
