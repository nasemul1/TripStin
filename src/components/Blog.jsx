...
const Blog = ({head, show, limit}) => {
    ...
    return (
        <div className="container mx-auto my-10 p-4">
            ...
            {(show===1) && <div className='mt-8 w-full flex justify-center'>
            ...
            {(show===0) && <div className="font-poppins text-sm flex justify-center items-center mt-6">
                <button
                    ...
                    className="px-4 py-2 mx-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 disabled:opacity-50"
                >
                    Previous
                </button>
